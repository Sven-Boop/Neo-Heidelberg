export const metadata = {
  title: 'Impressum — NEO Bar & Restaurant Heidelberg',
  robots: { index: false },
};
  ...
  return (
    <main className="legal-page">
      <div className="legal-inner">
        ...
        <p>
          Daniel Marquardt (Geschäftsführer)<br />
          Sven Günther (Geschäftsführer)<br />
          Swen Schmidt (Geschäftsführer)<br />
          Jens Schmidt (Geschäftsführer)
        </p>

        <h2>Kontakt</h2>
        <p>
          Telefon: <a href="tel:+4962214050660">06221 4050660</a><br />
        ...
        <p>
          ...
          Gewähr übernehmen. Als Diensteanbieter sind wir gemäß § 5 DDG für eigene Inhalte
          auf diesen Seiten nach den allgemeinen Gesetzen verantwortlich. Nach § 5 DDG sind
